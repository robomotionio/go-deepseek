...
function registerStrReplaceEditor(ctx, config) {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args, exec) {
      switch (args.command) {
        case "view":
          return viewPath(ctx, args.path, args.view_range ?? void 0, config.maxOutputChars, exec);
        case "create":
          return createFile(ctx, policy, args.path, args.file_text ?? void 0, exec);
        case "str_replace":
          return replaceInFile(ctx, policy, args.path, args.old_str ?? void 0, args.new_str, exec);
        case "insert":
          return insertInFile(ctx, policy, args.path, args.insert_line ?? void 0, args.new_str ?? void 0, exec);
      }
    },
