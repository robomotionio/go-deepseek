// .harness/packages/session/session-format-v2-to-v3/lib/index.js
...
function relationshipEvent(event) {
  ...
  if (event.type === "system/message") {
    const message2 = record(record(event.data, "system data")["message"], "system message");
    return {
      ...event,
      type: "user/message",
      data: {
...
var releasedV3SessionFormatCodec = Object.freeze({
  version: 3,
  decodeHeader(value) {
    return {
...
var sessionFormatV2ToV3 = defineSessionFormatMigration({
