// .harness/packages/session/session-title/lib/index.js
...
var EMPTY_TITLE_INPUT = {
  first: null,
  count: 0,
  lastSeq: null
};
var sessionTitleUserMessageSchema = z$1.object({
  seq: z$1.number().int().nonnegative().max(Number.MAX_SAFE_INTEGER).transform(SessionSeq),
  text: z$1.string()
}).strict();
var titleInputStateSchema = z$1.object({
...
var titleViewSchema = z$1.string().min(1).nullable();
var titleProjectionDefinition = {
  key: "title",
  stateVersion: 1,
...
export {
  ...
  SessionTitleService,
  SessionTitleService as default,
