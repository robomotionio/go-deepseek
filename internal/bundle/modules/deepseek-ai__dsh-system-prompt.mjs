// .harness/packages/core/system-prompt/lib/index.js
...
var PERSONA_PREFIX_SECTION = "deployment:persona-prefix";
var PERSONA_SUFFIX_SECTION = "deployment:persona-suffix";
